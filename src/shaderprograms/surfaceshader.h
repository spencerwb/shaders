...
public:
    ...
    int unifCamPos; // A handle for the "uniform" vec3 representing the camera's position in world space
...
public:
    ...
    // Pass the given camera position vector to this shader on the GPU
    void setCamPosMatrix(const glm::vec3 &pos);
};
